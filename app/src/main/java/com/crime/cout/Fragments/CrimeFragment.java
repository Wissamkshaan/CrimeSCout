        ...
        buttonSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mMap==null){
                    ...
                    crimeModels.clear();
                    crimeModels.addAll(sqLiteDatabaseHelper.getCrimeByZipCode(zipCode,category));
                    for(int i=0;i<crimeModels.size();i++){
                        drawMarker(i+"","crime",crimeModels.get(i).getCrimeName(),new LatLng(Double.parseDouble(crimeModels.get(i).getLatitude()),Double.parseDouble(crimeModels.get(i).getLongitude())),crimeModels.get(i).getCrimeType());
                    }
